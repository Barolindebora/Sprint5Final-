...
import {obtenerTodosLosPaisesPorCreadorDeboraControllerConResumen, mostrarIndexController, modificarPaisFormularioController, obtenerPaisPorIdController, obtenerTodosLosPaisesController, obtenerTodosLosPaisesPorCreadorDeboraController, crearPaisController, actualizarPaisPorIdController, borrarPaisIdController } from '../controller/paisController.mjs';
...
router.get('/dashboard',obtenerTodosLosPaisesPorCreadorDeboraControllerConResumen);
